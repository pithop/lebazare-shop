                        ...
                        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 space-y-6">
                            ...
                            <div>
                                ...
                                <div className="grid grid-cols-3 gap-2">
                                    <input type="number" name="dim_length" placeholder="L" className="px-3 py-2 border border-slate-200 rounded-lg" />
                                    <input type="number" name="dim_width" placeholder="l" className="px-3 py-2 border border-slate-200 rounded-lg" />
                                    <input type="number" name="dim_height" placeholder="H" className="px-3 py-2 border border-slate-200 rounded-lg" />
                                </div>
                            </div>

                            <div className="flex items-center gap-2">
                                <input type="checkbox" id="is_stackable" name="is_stackable" className="w-4 h-4 text-slate-900 rounded border-slate-300 focus:ring-slate-900" />
