    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (error) {
                ...
                // router.push('/login'); // Usually wait for verification, but Supabase might auto-login if disabled
            }
        } catch (error) {
        ...
        <div className="min-h-[70vh] flex items-center justify-center px-4 py-12 bg-stone-50">
            <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-sm border border-stone-100">
                <div className="text-center mb-8">
                    <h1 className="font-serif text-3xl text-slate-900 mb-2">Inscription</h1>
                    <p className="text-slate-500">Rejoignez la communauté LeBazare</p>
                </div>
